...
One board: read it, create it, change it, copy its structure, archive it.
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `boardId` | integer | yes | The board to copy. |
| `name` | string | yes | The new board's name. Trimmed, and at most 255 characters. |

### What comes back

| Field | Type | Description |
|-------|------|-------------|
| `board` | object | The new board: `id`, `name`, `style`, `image`, `color` and `status`. |
| `areas` | integer | How many columns were copied. |
